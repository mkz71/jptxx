        ...
        <div className={styles.about}>
          <section className={styles.aboutInfo}>
            ...
            <p className={styles.aboutParagraph}>
              ...
              authentic and traditional Chinese dishes in the area. We offer
              fast and friendly service whether you decide to have your meal
              delivered or choose to pick it up at our convenient location.
            </p>
            <p className={styles.aboutParagraph}>
              Addtionally, Formosa Café has been offering complete catering
              services. Contact us to help plan your next party or event. Our
              catering menu offers a variety of traditional, authentic Chinese
              dishes, and we will deliver to your home, office, school or
              banquet hall.
            </p>
          </section>
