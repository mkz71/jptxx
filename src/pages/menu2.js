...
const Menu2 = ({ data }) => {
  const sections = [
    ...
    {
      title: 'Fried Rice/Chow Mein/Lo Mein',
      subheader: 'Choice of combination, shrimp, chicken, beef, or pork'
    },
    { title: 'Egg Foo Young', subheader: 'Served with white rice and gravy' },
    {
      title: 'American',
      subheader: 'Served with fried Rice or french fries or steamed broccoli'
    },
    {
      title: 'Combo',
      subheader:
        'Please order by number! Served with egg roll and fried rice. Lunch (11AM - 3PM) includes can of soda || Dinner includes small soup'
    }
  ];
